...
class Vocab(object):
    ...
    def build_vocab(self):
        ...
        if not hasattr(self, 'unk_idx'):
            self.unk_idx = len(self.idx2sym)  # Assign a new index for <UNK>
            self.idx2sym.append('<UNK>')  # Add <UNK> symbol to the vocab
            self.sym2idx['<UNK>'] = self.unk_idx  # Add <UNK> to the index mapping
