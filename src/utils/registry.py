...
model = {
    ...
    "spikingssm": "models.spike.ss4d.SpikingSSM",  # Original standard version
    "loongspikingssm": "models.spike.loongspike.LoongSpikingSSM",  # Fractional version
...
layer = {
    ...
    "ss4d": "models.spike.ss4d.SS4D",  # Original standard version
    "loongspike": "models.spike.loongspike.LoongSpike",  # Fractional version
}
